...
<div className="container-fluid aboutus">
        ...
        <div className="blog-row p-3">
            <div className="row p-3">
                ...
                <img src={blog51} alt="" className="blog-img"/>
                </div>
                ...
                <Link to="/top-5-reasons-to-choose-an-interior-design-for-home" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={armeena} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect – Meena</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog52} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-to-choose-the-best-interior-designer" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog53} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-the-modular-kitchen-help-us-tips-to-maintenance" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog54} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/10-epic-decorating-ideas-to-your-kids-room" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={ardhivya} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Dhivya Arumugam</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog55} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/why-does-an-interior-designer-matter" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={armeena} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'>Architect Meena</h1>
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog56} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/tips-on-choosing-interior-contractor-for-residence" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog57} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-are-we-going-to-resume-our-office-after-lockdown" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog58} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-magical-wonder-will-happen-after-completing-your-home-interior-design" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={armuthulakshmi} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Muthulakshmi</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog59} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/why-an-interior-designer-matter" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arsaranya} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Saraniya</h1>
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog60} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/factors-to-consider-while-choosing-an-interior-design-company" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
  ...
  <Link to="/blog-6" ><span className="active">6</span></Link>
