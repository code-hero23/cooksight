...
<div className="container-fluid services-breadcrumb">
    ...
    <div className="container-fluid aboutus">
        ...
        <div className="blog-row p-3">
            <div className="row p-3">
                ...
                <img src={blog71} alt="" className="blog-img"/>
                </div>
                ...
                <Link to="/importance-of-interior-design-a-small-overview" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog72} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-to-choose-the-right-interior-design-company" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog73} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/interior-design-ideas-for-your-dream-home" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog74} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/tips-for-choosing-the-best-interior-designer-for-your-dream-home" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog75} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/why-experts-are-crucial-to-design-and-build-dream-homes" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog76} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/why-hire-an-interior-designer-instead-of-a-carpenter" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arsowmi} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Sowmithra</h1>
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog77} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/why-chennai" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={aranu} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Anulekha  </h1>
  ...
  <Link to="/blog-8" ><span className="active">8</span></Link>
  <Link to="/blog-8" ><span className="active">&raquo;</span></Link>
    </div>
        </div>
        <div className='col-md-2'></div>
    </div>
