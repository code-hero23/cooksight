...
const blog12 = '/blog-images/cookscape-blog-12.webp';
const blog13 = '/blog-images/cookscape-blog-13.webp';
const blog14 = '/blog-images/cookscape-blog-14.webp';
const blog15 = '/blog-images/cookscape-blog-15.webp';
const blog16 = '/blog-images/cookscape-blog-16.webp';
const blog17 = '/blog-images/cookscape-blog-17.webp';
const blog18 = '/blog-images/cookscape-blog-18.webp';
const blog19 = '/blog-images/cookscape-blog-19.webp';
const blog20 = '/blog-images/cookscape-blog-20.webp';

const arnavanitha = '/architects/Cookscape--Architect-navanitha.webp';
const arsunitha = '/architects/Cookscape--Architect-sunitha.webp';
const armanikandan = '/architects/Cookscape--Architect-manikandan.webp';
...
const arnivetha = '/architects/Cookscape--Architect-nivetha-senthil.webp';
const arsaranya = '/architects/Cookscape-Architect-Saranya.webp';
const armathivathini = '/architects/Cookscape--Architect-mathivathini.webp';
function Blog2() {
return (
<>
          ...
          <div className="blog-row p-3">
              <div className="row p-3">
                  <div className="col-md-3">
                      <img src={blog11} alt="" className="blog-img"/>
                  </div>
                  <div className="col-md-6">
                      ...
                      <Link to="/clever-storage-ideas-for-small-bedroom" ><button className="aboutus-button-2">View more</button></Link>
                  </div>
                  <div className="col-md-3">
                      <img src={arnavanitha} alt="" className="ar-img"/>
                      <h1 className='blog-title pt-3'> Architect Navanitha</h1>
                  </div>
              </div>
              <div className="row p-3">
                  <div className="col-md-3">
                      <img src={blog12} alt="" className="blog-img"/>
                  </div>
                   <div className="col-md-6">
                      ...
                      <Link to="/why-less-is-more-when-it-comes-to-home-interiors" ><button className="aboutus-button-2">View more</button></Link>
                  </div>
                  <div className="col-md-3">
                    <img src={arsunitha} alt="" className="ar-img"/>
                    <h1 className='blog-title pt-3'> Architect Sunitha</h1>
                  </div>
              </div>
              <div className="row p-3">
                  <div className="col-md-3">
                      <img src={blog13} alt="" className="blog-img"/>
                  </div>
                  <div className="col-md-6">
                      ...
                      <Link to="/inventive-ideas-under-stairs-storage" ><button className="aboutus-button-2">View more</button></Link>
                  </div>
                <div className="col-md-3">
                <img src={armanikandan} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Manikandan</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog14} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/10-brilliant-ways-to-brighten-your-dark-kitchen-living-room" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arvarshini} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Varshini</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog15} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-the-best-material-for-an-interior-design" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arraakesh} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Raakesh Natarajan</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog16} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/is-using-an-interior-designer-expensive" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arangaiyar} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Angaiyarkanni</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog17} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/transform-your-home-with-the-right-lighting" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={ardinesh} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Dinesh</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog18} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-do-you-design-the-best-kids-room-interior" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arnivetha} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Nivetha Senthil</h1>
                </div>
              </div>
              <div className="row p-3">
                <div className="col-md-3">
                <img src={blog19} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/ideas-to-design-a-multipurpose-living-room" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arsaranya} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Saraniya</h1>
                </div>
              </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog20} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/tamil-nadu-traditional-house-designs" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={armathivathini} alt="" className="ar-img"/>
            ...
            <div className='col-md-2'></div>
              <div className='col-md-8'>
                <div className="pagination  align-items-center">
                    <Link to="/blog" ><span>&laquo;</span></Link>
                    <Link to="/blog" ><span >1</span></Link>
                    <Link to="/blog-2" ><span className="active">2</span></Link>
                    <Link to="/blog-3" ><span>3</span></Link>
                    <Link to="/blog-4" ><span>4</span></Link>
                    <Link to="/blog-5" ><span>5</span></Link>
                    <Link to="/blog-6" ><span>6</span></Link>
                    <Link to="/blog-7" ><span>7</span></Link>
                    <Link to="/blog-8" ><span>8</span></Link>
                    <Link to="/blog-8" ><span>&raquo;</span></Link>
                </div>
              </div>
            <div className='col-md-2'></div>
          </div>
