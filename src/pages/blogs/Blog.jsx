...
const blog1 = '/blog-images/cookscape-blog-1.webp';
...
const blog5 = '/blog-images/cookscape-blog-5.webp';
const blog6 = '/blog-images/cookscape-blog-6.webp';
const blog7 = '/blog-images/cookscape-blog-7.webp';
const blog8 = '/blog-images/cookscape-blog-8.webp';
const blog9 = '/blog-images/cookscape-blog-9.webp';
const blog10 = '/blog-images/cookscape-blog-10.webp';
...
const arbhaghyasri = '/architects/Cookscape-Architect-bhagyashri.webp';
const arakila = '/architects/Cookscape--Architect-Akila.webp';
const arvarshini = '/architects/Cookscape--Architect-varshini.webp';
const argopal = '/architects/Cookscape-Architect-madhana-gopal.webp';
const arkeerthika = '/architects/Cookscape--Architect-keerthika.webp';
function Blog() {
  return (
<>
            ...
            <div className="blog-row p-3">
                <div className="row p-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <Link to="/understanding-the-theme-and-concept-in-interior-design"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                ...
                <div className="row p-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <Link to="/clever-design-solutions-for-a-rain-water-friendly-balcony"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                     <div className="col-md-3 ar">
                ...
                <div className="row p-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <Link to="/10-major-kitchen-storage-mistakes-to-avoid"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                ...
                <div className="row p-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <Link to="/what-businesses-can-be-combined-with-interior-designing-business"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3">
                ...
                <div className="row p-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <Link to="/7-amazing-wooden-ceiling-designs-you-will-love" ><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                        <img src={arbhaghyasri} alt="" className="ar-img"/>
                        <h1 className='blog-title pt-3'> Architect Bhaghyashri</h1>
                    </div>
                </div>
                <div className="row p-3">
                    <div className="col-md-3">
                        <img src={blog6} alt="" className="blog-img"/>
                    </div>
                    <div className="col-md-6">
                        ...
                        <Link to="/how-to-prevent-dampness-from-the-wall"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                        <img src={arakila} alt="" className="ar-img"/>
                        <h1 className='blog-title pt-3'> Architect Akila</h1>
                    </div>
                </div>
                <div className="row p-3">
                    <div className="col-md-3">
                        <img src={blog7} alt="" className="blog-img"/>
                    </div>
                    <div className="col-md-6">
                        ...
                        <Link to="/smarter-interior-design-for-the-smart-homes"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                ...
                <div className="row p-3">
                    <div className="col-md-3">
                        <img src={blog8} alt="" className="blog-img"/>
                    </div>
                    <div className="col-md-6">
                        ...
                        <Link to="/12-reasons-to-love-chalk-paint"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                        <img src={argopal} alt="" className="ar-img"/>
                        <h1 className='blog-title pt-3'> Architect CRE Madhana Gopal R</h1>
                    </div>
                </div>
                <div className="row p-3">
                    <div className="col-md-3">
                        <img src={blog9} alt="" className="blog-img"/>
                    </div>
                    <div className="col-md-6">
                        ...
                        <Link to="/indoor-decoration-ideas-with-money-plant"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                        <img src={arkeerthika} alt="" className="ar-img"/>
                        <h1 className='blog-title pt-3'> Architect Keerthika G</h1>
                    </div>
                </div>
                <div className="row p-3">
                    <div className="col-md-3">
                        <img src={blog10} alt="" className="blog-img"/>
                    </div>
                    <div className="col-md-6">
                        <h1 className='blog-title pt-3'> How can persuasive design be used in interior design?</h1>
                        <p className='blog-para'> Interior design is a profoundly proficient and enormous field where every creator follows an alternate example in a specific entryway. Each architect has their own process of designing from origination to the last completing of the venture.</p>
                        <Link to="/how-can-persuasive-design-be-used-in-interior-design"><button className="aboutus-button-2">View more</button></Link>
                    </div>
                    <div className="col-md-3 ar">
                        <img src={arbhaghyasri} alt="" className="ar-img"/>
                        <h1 className='blog-title pt-3'> Architect Bhaghyashri</h1>
            ...
            <div className='row'>
                ...
                <div className='col-md-8'>
                    <div className="pagination  align-items-center">
                        <Link to="/blog"> <span className="active">&laquo;</span></Link>
                        <Link to="/blog">  <span className="active">1</span></Link>
