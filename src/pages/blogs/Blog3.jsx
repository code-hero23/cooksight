...
<div className="container-fluid aboutus">
        ...
        <div className="blog-row p-3">
            <div className="row p-3">
                ...
                <img src={blog21} alt="" className="blog-img"/>
                </div>
                ...
                <Link to="/how-can-i-design-the-interior-of-my-home-with-a-low-budget" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog22} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-the-theme-concept-in-interior-design" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arkiruthiga} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Kiruthiga</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog23} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/easy-step-to-plan-your-kitchen-very-modular" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog24} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/how-is-interior-wall-thickness-determined" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arsabari} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Sabarinathan</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog25} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-calypso-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={arashika} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Aashika</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog26} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-suede-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog27} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-amaryllis-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog28} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-veneer-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
            ...
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog29} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-iris-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
                <img src={argautham} alt="" className="ar-img"/>
                <h1 className='blog-title pt-3'> Architect Gautham Lakshmikanthan</h1>
                </div>
            </div>
            <div className="row p-3">
                <div className="col-md-3">
                <img src={blog30} alt="" className="blog-img"/>
                </div>
                <div className="col-md-6">
                ...
                <Link to="/what-is-classic-variant" ><button className="aboutus-button-2">View more</button></Link>
                </div>
                <div className="col-md-3">
  ...
  <Link to="/blog-3" ><span className="active">3</span></Link>
